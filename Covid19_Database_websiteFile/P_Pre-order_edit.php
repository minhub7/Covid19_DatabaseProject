  ...
  <body>
    ...
    <div class="main-box">
        <div class="box">
            ...
            ?> 
            <form action="P_Pre-order_edit_update.php" method="POST">
                <table> 
                    <tr>
                    ...
                    <tr>
                        <td class="first"><span>CustomerID:</span></td> 
                        <td><input type="text" name="CustomerID" value="<?php echo $CustomerID; ?>" required></td>
                    </tr>
                    <tr>
                        <td class="first"><span>Deliverydate:</span></td> 
                        <td><input type="date" name="Deliverydate" value="<?php echo $Deliverydate; ?>" required></td>
                    </tr>
