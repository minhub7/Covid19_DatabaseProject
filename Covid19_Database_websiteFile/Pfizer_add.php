...
<html lang="ko">
  ...
  <body>
    <div class="main-box" style="padding-top: 20px;">
        ...
        <span class="main-title"><span class="korea">화이자</span> 를 추가해 주세요</span>
    </div>
    <div class="main-box">
        <div class="box">
            ...
            ?>
            <form action="Pfizer_add_update.php" method="POST">
                <table> 
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="MfgCo" value="Pfizer" readonly></td>
                    </tr>
                    <tr>
