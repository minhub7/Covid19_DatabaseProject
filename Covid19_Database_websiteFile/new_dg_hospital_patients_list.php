...
<div class="hospital_info-box_list">
   ...
   <div style="margin: 0 auto; width:770px; max-height: 500px; overflow-y: scroll;">
   <table align="center"class="hospital_info-table">
        <thead class="hospital_info-th">
         ...
         <tbody>
             ...
             $username=$_POST['uid'];
                ...
                $jb_confirmedcase_sql="SELECT * FROM newcovid19db.patients,newcovid19db.citizens,newcovid19db.patients_details where Hospname='대구병원'AND patients.Cssn=citizens.ssn AND patients_details.Hcode=patients.Hcode";
                ...
                while($row_confirmedcase = mysqli_fetch_array($jb_confirmedcase_result)){
                    ...
                    echo "<TD>", "
                    <form action='new_dg_hospital_patients_update.php' method='POST'>
    ...
    <form action='new_dg_patients_new.php' method='POST'>
    <input type='hidden' name='uid' value="<?=$_POST['uid']?>"/>
