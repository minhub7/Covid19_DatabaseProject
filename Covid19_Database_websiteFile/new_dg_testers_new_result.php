    ...
    <?php
        ...
        if ($ret[0] ==1){
            if($same_Hcode[0] ==1 ){
                ...
                echo "<form action='new_dg_testers_new.php' method='POST'>
            ...
            $jb_sql = "INSERT INTO testers VALUES('$Cssn', '$Testdate', '$Testnum', '대구병원')";
    ...
    ?>
      ...
      <table class="main-table">
        <tr>
          ...
          <td><p class="text-box">검진자 정보 추가에 성공하셨습니다</p></td>
        </tr>
      </table>
